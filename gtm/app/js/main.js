...
$(document).ready(function () {
  $(".main-breadcrumbs__box").on("click", function () {
    $(this).next(".main-breadcrumbs__sub-menu").toggleClass("active");
  });

  $(".main-breadcrumbs__sub-box").on("click", function () {
    $(this).next(".main-breadcrumbs__sub-menu3").toggleClass("active");
  });
});
